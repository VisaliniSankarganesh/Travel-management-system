...
public class booking_package extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    booking_package frame = new booking_package();
    ...
    public booking_package() {
        ...
        lblNewLabel.setText(pack.lblNewLabel_1.getText());
        contentPane.add(lblNewLabel);

        JLabel lblNewLabel_1 = new JLabel("New label");
        lblNewLabel_1.setBounds(65, 78, 132, 34);
        lblNewLabel_1.setText(pack.lblNewLabel_2.getText());
        contentPane.add(lblNewLabel_1);

        JLabel lblNewLabel_2 = new JLabel("New label");
        lblNewLabel_2.setBounds(592, 35, 223, 27);
        lblNewLabel_2.setText("Number of Travellers: " + (String) tamilnadu.comboBox.getSelectedItem());
        contentPane.add(lblNewLabel_2);

        JLabel lblNewLabel_3 = new JLabel("New label");
        lblNewLabel_3.setBounds(592, 85, 122, 27);
        lblNewLabel_3.setText("Car Type: " + (String) tamilnadu.comboBox_1.getSelectedItem());
        contentPane.add(lblNewLabel_3);

        JLabel lblNewLabel_4 = new JLabel("New label");
        lblNewLabel_4.setBounds(324, 35, 212, 27);
        lblNewLabel_4.setText("Date: " + tamilnadu.dateChooser.getDate());
        contentPane.add(lblNewLabel_4);

        JLabel lblNewLabel_5 = new JLabel("New label");
        lblNewLabel_5.setBounds(324, 82, 122, 27);
        lblNewLabel_5.setText("Total: " + (String) tamilnadu.textField.getText());
        ...
        btnNewButton.setBounds(444, 477, 389, 38);
        ...
        btnNewButton_1.setBounds(124, 477, 132, 38);
        contentPane.add(btnNewButton_1);

        int n = Integer.parseInt((String) tamilnadu.comboBox.getSelectedItem());
        for (int i = 0; i < n; i++) {
            y[i] = new details(i + 1);
            panel.add(y[i]);
        }
